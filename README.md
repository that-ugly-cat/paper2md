...
Interactive docs (auto-generated by FastAPI) are always up at `/docs` — useful
for poking at the schema, but the semantics below (auth, limits, what each
flag actually does to the output) aren't obvious from a Swagger page alone.
